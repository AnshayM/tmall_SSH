						...
						<div class="panel-body">
							<form method="post" class="addFormSingle"
								...
								<table class="addTable">
									...
									<tr>
										<td><input id="filepathSingle" type="file" name="img" />
										</td>
									</tr>
									<tr class="submitTR">
										<td align="center"><input type="hidden"
											name="productImage.type" value="type_single" /> <input
											type="hidden" name="productImage.product.id"
											value="${product.id}" />
						...
						<div class="panel-body">
							<form method="post" class="addFormDetail"
								...
								<table class="addTable">
									...
									<tr>
										<td><input id="filepathDetail" type="file" name="img" />
										</td>
									</tr>
									<tr class="submitTR">
										<td align="center"><input type="hidden"
											name="productImage.type" value="type_detail" /> <input
											type="hidden" name="productImage.product.id"
											value="${product.id}" />
											<button type="submit" class="btn btn-success">提 交</button></td>
									</tr>
