...
public class ServiceDelegateDAO {
	 ...
	 * @param lockMode
	 * @throws DataAccessException
	 * @see org.springframework.orm.hibernate3.HibernateTemplate#delete(java.lang.String,
	 ...
	 * @return
	 * @throws DataAccessException
	 * @see org.springframework.orm.hibernate3.HibernateTemplate#findByExample(java.lang.String,
	 ...
	 * @see pers.anshay.tmall.dao.impl.DAOImpl#setSessionFactory(org.hibernate.SessionFactory)
	 */
